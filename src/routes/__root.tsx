...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MasaQR is a SaaS platform for restaurants to manage QR menus, kitchen workflows, and operations." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "MasaQR — QR menus & kitchen flow for restaurants" },
      { property: "og:description", content: "MasaQR is a SaaS platform for restaurants to manage QR menus, kitchen workflows, and operations." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "MasaQR — QR menus & kitchen flow for restaurants" },
      { name: "twitter:description", content: "MasaQR is a SaaS platform for restaurants to manage QR menus, kitchen workflows, and operations." },
