// Azerbaijani UI strings for manager/waiter app.
// Customer menu uses its own per-item translations (name_i18n / description_i18n).
...
export const az = {
  ...
  auth: {
    ...
    join: {
      ...
      welcome: (n: string) => `Xoş gəlmisiniz, ${n}`,
...
export type AzStrings = typeof az;
export const T = az;
